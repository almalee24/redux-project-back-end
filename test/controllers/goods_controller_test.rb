...
class GoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create good" do
    assert_difference('Good.count') do
      post goods_url, params: { good: { name: @good.name, price: @good.price, weight: @good.weight } }, as: :json
    end
  ...
  test "should update good" do
    patch good_url(@good), params: { good: { name: @good.name, price: @good.price, weight: @good.weight } }, as: :json
    assert_response 200
  end
